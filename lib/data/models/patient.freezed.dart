  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      phMasterList: phMasterList == freezed
          ? _value.phMasterList
          : phMasterList as String,
      age: age == freezed ? _value.age : age as int,
      gender: gender == freezed ? _value.gender : gender as String,
      nationality:
          nationality == freezed ? _value.nationality : nationality as String,
      residence: residence == freezed ? _value.residence : residence as String,
      ...
      facility: facility == freezed ? _value.facility : facility as String,
...
class _$_Patient implements _Patient {
    ...
    return identical(this, other) ||
        (other is _Patient &&
            ...
            (identical(other.sequ, sequ) ||
                const DeepCollectionEquality().equals(other.sequ, sequ)) &&
            (identical(other.phMasterList, phMasterList) ||
                const DeepCollectionEquality()
                    .equals(other.phMasterList, phMasterList)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(sequ) ^
      const DeepCollectionEquality().hash(phMasterList) ^
